# takes qtl peak profile
# takes raw mapping data 
# takes trait (spot measurement)

# creates object for ggplot
# gets values to plot qtl profile
# for every peak encountered, genotype is extracted
# calculate Rˆ2
